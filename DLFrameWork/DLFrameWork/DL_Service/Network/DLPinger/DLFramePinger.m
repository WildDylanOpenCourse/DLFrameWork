#import "DLFramePinger.h"
#import "SimplePing.h"

@interface DLFramePinger () <SimplePingDelegate>
...
{
    while (self.lastPingTimes.count == self.averageNumberOfPings - 1) {
        [self.simplePing stop];
